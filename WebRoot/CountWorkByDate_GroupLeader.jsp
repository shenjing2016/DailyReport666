                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="findWorkByDate_GroupLeader" class="horizontal-form" method="post">
                                    <div class="row-fluid">
                                        <div class="span6 ">
										...
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="input-append date date-picker" data-date="2017-03-04" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
													<input id="endTime" name="endTime" class="m-wrap m-ctrl-medium date-picker" readonly size="10" type="text" value="" style="height:20px;" /><span class="add-on"><i class="icon-calendar"></i></span>
												</div>
											</div>
										</div>
										<!--/span-->
                                ...
                                <div class="clearfix">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                      <thead>
										...
										<c:forEach items="${DRWorkList}" var="dr">
											<tr>
												<th>${dr.userId}</th>
												<th>${dr.userName}</th>
												<th><fmt:formatDate value="${dr.startTime}"
														pattern="yyyy-MM-dd" />~<fmt:formatDate
														value="${dr.endTime}" pattern="yyyy-MM-dd" /></th>
												<th>${dr.work}</th>
												<th>${dr.exWork}</th>
												<th>${dr.totalWork}</th>
											</tr>
