            ...
            <!-- END PAGE CONTAINER-->
                    ...
                    <div class="row-fluid">
                        <div class="span3 responsive" data-tablet="span6" data-desktop="span3" style="margin-left:20px">
							<a href="${pageContext.request.contextPath }/jumpToInsertUser.action" style="text-decoration:none">
			            		<div class="move">
			            			<img src="media/image/xinzengyuangong.png" alt="新增员工" width="246" height="246"/>
			            		</div>
			            	</a><br/>
                        ...
                        <div class="span3 responsive" data-tablet="span6" data-desktop="span3" style="margin-left:20px">
			            	<a href="${pageContext.request.contextPath }/addproject1_Admin.action" style="text-decoration:none">
			            		<div class="move">
			            			<img src="media/image/xinzengxiangmu.png" alt="新增项目" width="246" height="246"/>
			            		</div>
			            	</a><br/>
			            	<ul class="breadcrumb" style="margin-right:15px">
			            		<center>新增项目</center>
                        ...
                        <div class="span3 responsive" data-tablet="span6" data-desktop="span3" style="margin-left:20px">
			            	<a href="${pageContext.request.contextPath }/adddepartment1_Admin.action" style="text-decoration:none">
			            		<div class="move">
			            			<img src="media/image/xinzengbumen.png" alt="新增部门" width="246" height="246"/>
			            		</div>
			            	</a><br/>
			            	<ul class="breadcrumb" style="margin-right:15px">
			            		<center>新增部门</center>
                        ...
                        <div class="span3 responsive" data-tablet="span6" data-desktop="span3" style="margin-left:20px">
			            	<a href="${pageContext.request.contextPath }/updateUserSelf_Admin.jsp" style="text-decoration:none">
			            		<div class="move">
