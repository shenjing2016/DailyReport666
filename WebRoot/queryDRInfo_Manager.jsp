...
<head>
    ...
    <script type="text/javascript">
        function c1(){
        	if($("#check").is(":checked")){
        		document.getElementById("DaliyReport").action="checkdr_Manager.action?drStatus=1";
        ...
        function c2(){
        	if($("#check").is(":checked")){
        		document.getElementById("DaliyReport").action="checkdr_Manager.action?drStatus=2";
                document.getElementById("DaliyReport").submit();
        	}
        	else{
        		swal("请选择需要审核的日报");
                    ...
                    <div class="span12">
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="reviewquery_Manager.action" class="horizontal-form" method="post">
                                    <div class="row-fluid">
                                        <div class="span6 ">
                                    ...
                                    <tbody>
                                    	<c:forEach items="${custom}" var="b">
        									<tr>
    											...
    											<td><a href="alterquery_Manager.action?drId=${b.drId}">修改</a></td>
        									</tr>
