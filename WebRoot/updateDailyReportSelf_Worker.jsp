                    ...
                    <div class="span12">
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="uqueryDailyReportSelf_Worker" class="horizontal-form" method="post">
                                    <div class="row-fluid">
                                        <div class="span3 ">
                        ...
                        <div id="form_modal3" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true">
                            <form action="updateDailyReportSelf_Worker" class="form-horizontal" id="updateDailyReportForm" name="updateDailyReportForm" >
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="hidden" name="userId" id="drId4" value="${userId}">
