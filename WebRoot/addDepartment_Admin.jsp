...
<body class="page-header-fixed">
                    ...
                    <div class="span12">
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                ...
                                <!-- BEGIN FORM-->
                                <form onsubmit="return aa()" action="adddepartment_Admin" class="horizontal-form" method="post">
                                    <div class="row-fluid">
                                        <div class="span6 ">
                                            <div class="control-group">
                                                <label class="control-label" for="firstName">部门ID</label>
                                                <div class="controls">
                                                    <input type="text" id="deptId" name="deptId" class="m-wrap span12" placeholder="请输入部门ID" onblur="bb(this)">                  
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="span6 ">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" id="deptName" name="deptName" class="m-wrap span12" placeholder="请输入部门名称" onblur="bb(this)">
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
    ...
    function aa()
    {
    	var id1=document.getElementById("deptId").value;
    	var deptName=document.getElementById("deptName").value;
    	if(id1.length==0||deptName.length==0)
    		{alert("请填写信息");
    		return false;
    		}
