                    ...
                    <div class="span12">
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="qqueryDailyReportSelf_Worker" class="horizontal-form" method="post">
                                    <div class="row-fluid">
                                        <div class="span3 ">
                                        ...
                                        <div class="span3 ">
                                            <div class="control-group">
                                                ...
                                                <div class="input-append date date-picker" data-date="2017-03-25" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
