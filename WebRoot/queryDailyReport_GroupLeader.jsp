                    ...
                    <div class="span12">
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="queryDailyReport_GroupLeader" class="horizontal-form" method="post">
                                    <div class="row-fluid">
                                        <div class="span3 ">
                        ...
                        <div id="form_modal3" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true">
                            <form action="updateDailyReport_GroupLeader" class="form-horizontal" name="updateDailyReportForm" >
                                <div class="modal-header">
