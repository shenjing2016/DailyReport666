            ...
            <ul class="page-sidebar-menu">
                ...
                <li class="">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath }/findWeekReportById_Manager.jsp">
                ...
                <li class="">
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a href="${pageContext.request.contextPath }/updateUserSelf_Manager.jsp">
            ...
            <!-- END PAGE CONTAINER-->
                    ...
                    <div class="row-fluid">
                        <div class="span3 responsive" data-tablet="span6" data-desktop="span3" style="margin-left:20px">
							<a href="${pageContext.request.contextPath }/jumpToInsertDailyReportPage_Manager.action?userId=${userId }" style="text-decoration:none">
			            		<div class="move">
                        ...
                        <div class="span3 responsive" data-tablet="span6" data-desktop="span3" style="margin-left:20px">
			            	<a href="${pageContext.request.contextPath }/jumpToQueryDailyReportSelf_Manager.action?userId=${userId}" style="text-decoration:none">
			            		<div class="move">
                        ...
                        <div class="span3 responsive" data-tablet="span6" data-desktop="span3" style="margin-left:20px">
			            	<a href="review_Manager.action" style="text-decoration:none">
			            		<div class="move">
			            			<img src="media/image/ribaoshenhe.png" alt="日报审核" width="246" height="246"/>
			            		</div>
			            	</a><br/>
			            	<ul class="breadcrumb" style="margin-right:15px">
			            		<center>日报审核</center>
                        ...
                        <div class="span3 responsive" data-tablet="span6" data-desktop="span3" style="margin-left:20px">
			            	<a href="${pageContext.request.contextPath }/CountWorkByProjId_Manager.jsp" style="text-decoration:none">
			            		<div class="move">
			            			<img src="media/image/xiangmugongshi.png" alt="按项目统计工时" width="246" height="246"/>
			            		</div>
			            	</a><br/>
			            	<ul class="breadcrumb" style="margin-right:15px">
			            		<center>按项目统计工时</center>
			            	</ul>
                        </div>
                    </div>
                    ...
                    <div class="row-fluid">
                        <div class="span3 responsive" data-tablet="span6" data-desktop="span3" style="margin-left:20px">
							<a href="${pageContext.request.contextPath }/CountWorkByDate_Manager.jsp" style="text-decoration:none">
			            		<div class="move">
			            			<img src="media/image/riqigongshi.png" alt="按日期统计工时" width="246" height="246"/>
			            		</div>
			            	</a><br/>
			            	<ul class="breadcrumb" style="margin-right:15px">
			            		<center>按日期统计工时</center>
			            	</ul>
                        </div>
                        <div class="span3 responsive" data-tablet="span6" data-desktop="span3" style="margin-left:20px">
			            	<a href="${pageContext.request.contextPath }/findWeekReportById_Manager.jsp" style="text-decoration:none">
			            		<div class="move">
			            			<img src="media/image/zhoubaodaochu.png" alt="职员周报导出" width="246" height="246"/>
			            		</div>
			            	</a><br/>
			            	<ul class="breadcrumb" style="margin-right:15px">
			            		<center>职员周报导出</center>
			            	</ul>
                        </div>
                        <div class="span3 responsive" data-tablet="span6" data-desktop="span3" style="margin-left:20px">
			            	<a href="${pageContext.request.contextPath }/jumpToUpdateDailyReportSelf_Manager.action?userId=${userId}" style="text-decoration:none">
			            		<div class="move">
			            			<img src="media/image/xiugairibao.png" alt="修改个人日报" width="246" height="246"/>
			            		</div>
			            	</a><br/>
			            	<ul class="breadcrumb" style="margin-right:15px">
			            		<center>修改个人日报</center>
			            	</ul>
                        </div>
                        <div class="span3 responsive" data-tablet="span6" data-desktop="span3" style="margin-left:20px">
			            	<a href="${pageContext.request.contextPath }/updateUserSelf_Manager.jsp" style="text-decoration:none">
			            		<div class="move">
