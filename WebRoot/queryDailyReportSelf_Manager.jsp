                ...
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown user">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="${pageContext.request.contextPath }/updateUserSelf_Manager.action"><i class="icon-tasks"></i> 修改个人信息</a></li>
                            <li class="divider"></li>
                    ...
                    <div class="span12">
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="qqueryDailyReportSelf_Manager" class="horizontal-form" method="post">
                                    <div class="row-fluid">
                                        <div class="span3 ">
