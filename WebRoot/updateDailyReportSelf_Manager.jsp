...
<body class="page-header-fixed">
                    ...
                    <div class="span12">
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="uqueryDailyReportSelf_Manager" class="horizontal-form" method="post">
                                    <div class="row-fluid">
                                        <div class="span3 ">
                                            <div class="control-group">
                                                <label class="control-label">查询起始日期</label>
                                                <div class="input-append date date-picker" data-date="2017-03-03" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
                                    ...
                                    <tbody>
                                    	<c:forEach items="${dailyReportList}" var="d">
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td><a href="#form_modal3" data-toggle="modal" class="btn mini yellow update"><i class="icon-edit"></i> 修改</a></td>
                        ...
                        <div id="form_modal3" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true">
                            <form action="updateDailyReportSelf_Manager" class="form-horizontal" name="updateDailyReportForm" >
                                <div class="modal-header">
                        ...
                        <div id="form_modal4" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true">
                            <form action="updateDailyReport" class="form-horizontal"  >
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
    ...
    jQuery(document).ready(function() {
        ...
        $('#sample_2 a.update').live('click', function(e) {
            ...
            $('#drId').val($(this).parent().parent().children().first().next().text());
