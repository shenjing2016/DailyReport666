                    ...
                    <div class="span12">
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                ...
                                <!-- BEGIN FORM-->
                                <form action="adddepartment.action" class="horizontal-form" method="post">
                                    <div class="row-fluid">
                                        <div class="span6 ">
                                            <div class="control-group">
                                                <label class="control-label" for="firstName">部门ID</label>
                                                <div class="controls">
                                                    <input type="text" id="deptId" name="deptId" class="m-wrap span12" placeholder="请输入部门ID">                  
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="span6 ">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" id="deptName" name="deptName" class="m-wrap span12" placeholder="请输入部门名称">
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
