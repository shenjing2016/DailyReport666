                    ...
                    <div class="span12">
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                ...
                                <!-- BEGIN FORM-->
                                <form action="updateproject2_GroupLeader.action" class="horizontal-form" method="post">
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="span6 ">
                                            <div class="control-group">
                                                <label class="control-label" for="firstName">项目ID</label>
                                                <div class="controls">
                                                    <input type="text" readonly="true" id="projId" name="projId" class="m-wrap span12" value="${p.projId}">
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                     ...
                                     <div class="row-fluid">
                                        ...
                                        <div class="span6 ">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" disabled="true" id="projName" name="projName" class="m-wrap span12" value="${p.projName}">
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row-fluid">
                                        <div class="span6 ">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select class="m-wrap span12" name="projStatus">
