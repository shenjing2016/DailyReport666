                    ...
                    <div class="span12">
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                ...
                                <!-- BEGIN FORM-->
                                <form action="addproject2" class="horizontal-form" method="post">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span6 ">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" id="projName" name="projName" class="m-wrap span12" placeholder="请输入部门名称">
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row-fluid">
                                        <div class="span6 ">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="date" id="projStartTime" name="projStartTime" class="m-wrap span12">
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="span6 ">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="date" id="projDeadTime" name="projDeadTime" class="m-wrap span12">
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
