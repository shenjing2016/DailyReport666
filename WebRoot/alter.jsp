                                ...
                                <div class="tabbable portlet-tabs">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="portlet_tab1">
                                            <!-- BEGIN FORM-->
                                            <form action="alter.action" method="post" class="form-horizontal">
                                                ...
                                                <div class="form-actions">
                                                    ...
                                                    <button type="button" class="btn" onclick="window.location.href='review.action'">返回</button>
                                                </div>
                                            </form>
                                            <!-- END FORM-->
                                        </div>
