                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="findWorkByProjId_GroupLeader" class="horizontal-form" method="post">
                                    <div class="row-fluid">
                                        <div class="span6 ">
                                            <div class="control-group">
                                                <label class="control-label" for="firstName">项目名称</label>
                                                <div class="controls">
                                                    <input type="text" id="projName" name="projName" class="m-wrap span12">
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="span6 ">
                                            <div class="control-group">
                                                <label class="control-label" for="firstName" >项目编号</label>
                                                <div class="controls">
													<input type="text" name="projId" id="projId" class="m-wrap span12">
												</div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                ...
                                <div class="clearfix">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                      <thead>
										...
										<c:forEach items="${ProjectWork}" var="pw">
											<tr>
												<th>${pw.projName}</th>
												<th>${pw.projId}</th>
												<th>${pw.work}</th>
