                ...
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown user">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="${pageContext.request.contextPath }/insertDailyReport_GroupLeader.action"><i class="icon-envelope"></i> 新建日报</a></li>
            ...
            <!-- END PAGE CONTAINER-->
                    ...
                    <div class="row-fluid">
                        <div class="span3 responsive" data-tablet="span6" data-desktop="span3" style="margin-left:20px">
							<a href="${pageContext.request.contextPath }/jumpToInsertDailyReportPage_GroupLeader.action?userId=${userId }" style="text-decoration:none">
			            		<div class="move">
                        ...
                        <div class="span3 responsive" data-tablet="span6" data-desktop="span3" style="margin-left:20px">
			            	<a href="${pageContext.request.contextPath }/jumpToQueryDailyReportSelf_GroupLeader.action?userId=${userId}" style="text-decoration:none">
			            		<div class="move">
                        ...
                        <div class="span3 responsive" data-tablet="span6" data-desktop="span3" style="margin-left:20px">
			            	<a href="review_GroupLeader.action" style="text-decoration:none">
			            		<div class="move">
                        ...
                        <div class="span3 responsive" data-tablet="span6" data-desktop="span3" style="margin-left:20px">
			            	<a href="${pageContext.request.contextPath }/CountWorkByProjId_GroupLeader.jsp" style="text-decoration:none">
			            		<div class="move">
                    ...
                    <div class="row-fluid">
                        <div class="span3 responsive" data-tablet="span6" data-desktop="span3" style="margin-left:20px">
							<a href="${pageContext.request.contextPath }/CountWorkByDate_GroupLeader.jsp" style="text-decoration:none">
			            		<div class="move">
                        ...
                        <div class="span3 responsive" data-tablet="span6" data-desktop="span3" style="margin-left:20px">
			            	<a href="${pageContext.request.contextPath }/findWeekReportById_GroupLeader.jsp" style="text-decoration:none">
			            		<div class="move">
                        ...
                        <div class="span3 responsive" data-tablet="span6" data-desktop="span3" style="margin-left:20px">
			            	<a href="${pageContext.request.contextPath }/updateproject_GroupLeader.action" style="text-decoration:none">
			            		<div class="move">
			            			<img src="media/image/gaijindu.png" alt="更改项目进度" width="246" height="246"/>
			            		</div>
			            	</a><br/>
			            	<ul class="breadcrumb" style="margin-right:15px">
			            		<center>更改项目进度</center>
			            	</ul>
                        </div>
                        <div class="span3 responsive" data-tablet="span6" data-desktop="span3" style="margin-left:20px">
			            	<a href="${pageContext.request.contextPath }/updateUserSelf_GroupLeader.jsp" style="text-decoration:none">
			            		<div class="move">
